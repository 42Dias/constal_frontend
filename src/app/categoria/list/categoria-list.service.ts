...
import categoriaExporterFields from 'src/app/categoria/list/categoria-exporter-fields';
...
export class CategoriaListService {
  rows = [];
  count = 0;
  loading = false;
  filter: any = {};
  ...
  async doExport() {
    try {
      ...
      const response = await CategoriaApi.list(
        filter,
        this.orderBy,
        null,
        null,
