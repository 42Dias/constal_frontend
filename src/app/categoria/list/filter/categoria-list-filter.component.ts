...
@Component({
  selector: 'app-categoria-list-filter',
  templateUrl: './categoria-list-filter.component.html',
})
export class CategoriaListFilterComponent implements OnInit {
  form: FormGroup;
  schema: FilterSchema;
  expanded: boolean = false;

  constructor(
    private service: CategoriaListService,
