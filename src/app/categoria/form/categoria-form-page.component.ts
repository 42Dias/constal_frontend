...
import { CategoriaFormPageService } from 'src/app/categoria/form/categoria-form-page.service';
import { AuthService } from 'src/app/auth/auth.service';

@Component({
  selector: 'app-categoria-form-page',
  templateUrl: './categoria-form-page.component.html',
})
export class CategoriaFormPageComponent implements OnInit {
  constructor(
    private service: CategoriaFormPageService,
  ...
  breadcrumb = [
    ...
    [
      this.isEditing
        ? i18n('entities.categoria.edit.title')
        : i18n('entities.categoria.new.title'),
    ],
  ];
