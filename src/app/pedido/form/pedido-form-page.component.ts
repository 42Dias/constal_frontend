...
import { PedidoFormPageService } from 'src/app/pedido/form/pedido-form-page.service';
...
export class PedidoFormPageComponent implements OnInit {
  constructor(
    private service: PedidoFormPageService,
